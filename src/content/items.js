...
export const ITEMS = {
  ...
  bergschluessel: {
    ...
    textDe: "Löst die Winde der Seilbahnstation im Wolkenjoch (Kapitel V) — ein Techniker im Hofstaat wartet das Werk.",
    ...
    loreDe: "Löst die eingefrorene Winde der Seilbahnstation im Wolkenjoch (Kapitel V). ACHTUNG: Der Schlüssel allein genügt nicht — ein Techniker muss in deinem Hofstaat stehen, der das Werk wartet. Erst beide zusammen öffnen die Station.",
  ...
  kriegsaxt: {
    ...
    textDe: "Sprengt das Schwarze Tor im Aschgrund (Kapitel VI) — mit einem Schildträger als Rammstoß.",
    textEn: "Breaches the Black Gate in the Badlands (Chapter VI) — with a Guardian as the ram.",
    loreDe: "Sprengt das Schwarze Tor im Aschgrund (Kapitel VI). ACHTUNG: Die Axt braucht Muskeln — ein Schildträger in deinem Hofstaat rammt das Tor auf. Ohne ihn bleibt es verschlossen, so scharf die Schneide auch ist.",
  ...
  kamel: {
    ...
    textDe: "Trägt dich durch das Dürrgras der Sattelweite (Kapitel VII) zur Karawanenrast der Händler.",
    textEn: "Carries you through the Sattelweite's dry grass (Chapter VII) to the traders' caravan rest.",
    loreDe: "Trägt dich durch das Dürrgras der Sattelweite (Kapitel VII) bis zur Karawanenrast der Händler. Ein Reittier als Schlüssel: Es kämpft nicht mit, es bringt dich nur dorthin, wo du zu Fuß umkehren müsstest.",
  ...
  sternenkompass: {
    ...
    textDe: "Weist im Sonnenschlund (Kapitel IX) den Nachtpfad zum Verborgenen Schrein — nur ein Späher liest die Zeichen. Der Sieg schenkt einen Lebenstrank.",
    textEn: "Points the night path to the Hidden Shrine in the Sonnenschlund (Chapter IX) — only a Pathfinder reads the signs. Victory grants a healing draught.",
    loreDe: "Weist im Sonnenschlund (Kapitel IX) den Nachtpfad zum Verborgenen Schrein. ACHTUNG: Die Sternzeichen liest nur ein Späher aus deinem Hofstaat. Der Sieg an diesem Schrein schenkt dir zusätzlich einen Lebenstrank.",
    loreEn: "Shows the night path to the Hidden Shrine in the Sonnenschlund (Chapter IX). NOTE: only a Hawk from your court reads the star signs. Victory at that shrine also grants you a healing draught.",
  },
  anker: {
