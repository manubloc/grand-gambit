...
export const ITEMS = {
  ...
  machete: {
    id: "machete", emoji: "🌿", kind: "key", gold: 50,
  ...
  kamel: {
    id: "kamel", emoji: "🐫", kind: "key", gold: 70,
  ...
  donnerpulver: {
    id: "donnerpulver", emoji: "🧨", kind: "key", gold: 60,
  ...
  sternenkompass: {
    id: "sternenkompass", emoji: "🧭", kind: "key", gold: 65,
  ...
  anker: {
    id: "anker", emoji: "⚓", kind: "key", gold: 90,
  ...
  brieftaube: {
    id: "brieftaube", emoji: "🐦", kind: "key", gold: 35,
  ...
  boat: {
    id: "boat", emoji: "🛶", kind: "key", gold: 140,
