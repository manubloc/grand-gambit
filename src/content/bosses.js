...
export const BOSSES = [
  ...
  B("b02", "Der Hetzer",       "The Harrier",     "beast",   "#ffb454",  7, 3, { leaps: CAMEL }, { flavorDe: "Was er einmal wittert, holt er ein; kein Umweg ist ihm zu weit, kein Fels zu steil.", flavorEn: "What he scents once he runs down; no detour is too far, no rock too steep.", abilities: ["regen"] }),  // 9->7: heilt fortan
  ...
  B("b06", "Das Bollwerk",     "The Bulwark",     "golem",   "#9aa5b7", 11, 2, { slides: DIAG, range: 1 }, { flavorDe: "Man baute es, um etwas fernzuhalten. Niemand weiß mehr, was — es selbst weiß es noch.", flavorEn: "It was built to keep something out. No one remembers what — it still does.", abilities: ["bulwark"] }),  // 18->11: Kapitel-I-Grenze (12 Schlaege atk-2)
  ...
  B("b10", "Doppelritter",     "Twin Knight",     "beast",   "#3d9bff", 11, 3, { leaps: [...KNIGHT, ...KING] }, { flavorDe: "Zwei Sättel, ein Wille: Wo einer täuscht, trifft der andere.", flavorEn: "Two saddles, one will: where one feints, the other strikes.", aura: { type: "wardAdj" }, abilities: ["regen"] }),
  ...
  B("b16", "Die Blutmagd",     "The Bloodmaid",   "serpent", "#fb7185", 10, 4, { slides: KING, range: 1, leaps: [[0, 2], [0, -2]] }, { flavorDe: "Sie diente einst am Krankenbett — dann fand sie heraus, wohin das Blut wirklich fließt.", flavorEn: "She once served at sickbeds — then she learned where the blood truly flows.", aura: { type: "grant", id: "lifesteal" }, abilities: ["lifesteal"] }),
  ...
  B("b23", "Asra, die Erzfeindin", "Asra, the Archenemy",   "tyrant",  "#fbbf24", 13, 4, { slides: KING, range: 3 }, { flavorDe: "Sie kannte den Hof, ehe sie ihn verriet — deshalb weiß sie, wo er weich ist.", flavorEn: "She knew the court before she betrayed it — that is why she knows where it is soft.", abilities: ["regen"] }),
