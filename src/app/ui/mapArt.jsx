...
export const LEAGUE_THEMES = [
  null,
  { id: "fruehling", nameDe: "Kronland", bitmap: "fruehling", paper: "#e9ecd8", wash: [["0%","#6f9a5c",.3],["45%","#9ab86f",.2],["100%","#7aa06a",.24]], tones: TONES.spring, pines: 120, far: 70, leafy: [14, "#8fbf6f", "#b8dd93"], blossoms: 12, river: "#a9c2cf", mystic: { mists: 4, wisps: 8 }, settle: true, ridges: 1, caps: true, birds: 4 },
  { id: "sommer", nameDe: "Kornmark", bitmap: "sommer", paper: "#ece5d2", wash: [["0%","#5f7a52",.28],["45%","#c9b68a",.24],["100%","#8e2f39",.2]], tones: TONES.summer, pines: 150, far: 85, leafy: [15, null, null], river: "#a9b6c4", mystic: { mists: 6, wisps: 12, crystals: 7, dead: 9, stones: true, ruin: true }, settle: true, ridges: 1, caps: true, birds: 3 },
  { id: "herbst", nameDe: "Eichwald", bitmap: "herbst", paper: "#ecdfc4", wash: [["0%","#a86a2e",.26],["45%","#c98a3a",.22],["100%","#7a3a2a",.26]], tones: TONES.autumn, pines: 130, far: 75, leafy: [18, "#c07a2a", "#e0a54e"], river: "#a9b6c4", mystic: { mists: 8, wisps: 10 }, settle: true, ridges: 1, caps: true, birds: 5 },
  { id: "krummholz", nameDe: "Krummholz", bitmap: "krummholz", paper: "#e9e8da", wash: [["0%","#7f9066",.26],["45%","#a8ab84",.2],["100%","#5c6b56",.26]], tones: TONES.alpine, pines: 100, far: 55, leafy: [8, "#8a9a5e", "#b3bd84"], rocks: 22, river: "#b9c6c8", mystic: { mists: 8, wisps: 6 }, settle: true, ridges: 2, caps: true, birds: 3 },
  { id: "winter", nameDe: "Grauwacht", bitmap: "winter", paper: "#eef1f4", wash: [["0%","#8fa7bd",.22],["45%","#c9d6e2",.18],["100%","#6d84a3",.26]], tones: TONES.winter, snow: true, pines: 130, far: 75, leafy: [0], drifts: 14, river: "#d7e5ee", frozen: true, mystic: { mists: 9, wisps: 8 }, settle: true, ridges: 1.2, caps: true, birds: 2 },
  { id: "hochgebirge", nameDe: "Wolkenjoch", bitmap: "hochgebirge", paper: "#e4e3dc", wash: [["0%","#7d8593",.24],["45%","#9aa2ae",.2],["100%","#5d6675",.28]], tones: TONES.alpine, snow: true, pines: 60, far: 40, leafy: [0], rocks: 34, drifts: 10, river: "#c4d6e0", mystic: { mists: 10 }, settle: false, ridges: 3, caps: true, birds: 2 },
  { id: "oedland", nameDe: "Aschgrund", bitmap: "oedland", paper: "#e0dbc9", wash: [["0%","#8a7f66",.26],["45%","#a3947a",.2],["100%","#6e6250",.28]], tones: TONES.dry, pines: 0, far: 0, leafy: [0], dead: 18, rocks: 40, river: null, mystic: { mists: 5 }, settle: false, ridges: 2.2, caps: false, birds: 1 },
  { id: "steppe", nameDe: "Sattelweite", bitmap: "steppe", paper: "#eadfb8", wash: [["0%","#b09a52",.24],["45%","#c9ae62",.2],["100%","#8a6f3a",.26]], tones: TONES.dry, pines: 0, far: 0, leafy: [8, "#a9964e", "#c7b46a"], dead: 16, grass: 34, rocks: 12, river: "#b7c0b2", mystic: { wisps: 5 }, settle: true, ridges: 0.8, caps: false, birds: 4 },
  { id: "canyon", nameDe: "Die Wunde", bitmap: "canyon", paper: "#e6cdb0", wash: [["0%","#b0603a",.26],["45%","#c97a4a",.22],["100%","#8a3a2a",.3]], tones: TONES.dry, pines: 0, far: 0, leafy: [0], cacti: 10, rocks: 30, dead: 6, river: null, mystic: {}, settle: false, ridges: 2.6, caps: false, birds: 2 },
  { id: "wueste", nameDe: "Sonnenschlund", bitmap: "wueste", paper: "#ecd9ac", wash: [["0%","#d9a95c",.26],["45%","#e8c377",.2],["100%","#b0763a",.3]], tones: TONES.dry, pines: 0, far: 0, leafy: [0], cacti: 16, dunes: 12, rocks: 10, river: null, oasis: true, mystic: {}, settle: false, ridges: 1.2, caps: false, birds: 2 },
...
export const themeForLeague = (league) => LEAGUE_THEMES[((Math.max(1, league) - 1) % 11) + 1];
