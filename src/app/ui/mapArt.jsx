...
export const LEAGUE_THEMES = [
  ...
  { id: "winter", nameDe: "Gebirge", bitmap: "winter", paper: "#eef1f4", wash: [["0%","#8fa7bd",.22],["45%","#c9d6e2",.18],["100%","#6d84a3",.26]], tones: TONES.winter, snow: true, pines: 130, far: 75, leafy: [0], drifts: 14, river: "#d7e5ee", frozen: true, mystic: { mists: 9, wisps: 8 }, settle: true, ridges: 1.2, caps: true, birds: 2 },
