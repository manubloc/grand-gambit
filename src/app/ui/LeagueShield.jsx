...
export function LeagueShield({ league = 1, size = 58, dim = false, style }) {
  ...
  const fs = size * (txt.length <= 1 ? 0.235 : txt.length === 2 ? 0.2 : txt.length === 3 ? 0.165 : 0.135);
  return (
    <span aria-hidden style={{ position: "relative", display: "inline-block", width: size * AR, height: size,
      ...
      <img src={leagueShield()} alt="" style={{ width: "100%", height: "100%", objectFit: "contain", display: "block" }} />
